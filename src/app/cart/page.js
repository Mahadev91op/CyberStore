      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#050505] text-white relative overflow-hidden px-4">
        ...
        <div className="bg-[#111]/80 backdrop-blur-xl p-10 rounded-3xl shadow-2xl max-w-md w-full border border-white/10 text-center relative z-10">
          ...
          <p className="text-gray-500 mb-8 text-sm">
            Looks like you haven't added any PC parts yet.
          </p>
          <Link
            href="/"
    ...
    <div className="min-h-screen bg-[#050505] text-white py-12 relative selection:bg-red-500 selection:text-white">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <h1 className="text-4xl font-black text-white mb-8 flex items-center gap-4">
          Shopping Cart{" "}
          <span className="text-lg font-medium text-gray-500 bg-white/10 px-3 py-1 rounded-full border border-white/5">
            {cart.length} items
          </span>
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cart.map((item) => (
              <div
                key={item._id}
                className="bg-[#111] p-5 rounded-2xl border border-white/10 flex flex-col sm:flex-row items-center gap-6 transition-all hover:border-white/20 group hover:bg-[#151515]"
              >
                {/* Image */}
                ...
                <div className="flex-1 text-center sm:text-left w-full">
                  <Link
                    ...
                    className="hover:text-red-500 transition block mb-1"
                  >
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#111] p-6 rounded-3xl border border-white/10 sticky top-24 shadow-2xl shadow-black/50">
              ...
              <div className="space-y-4 text-sm mb-6 text-gray-400">
                ...
                <div className="flex justify-between">
                  <span>Shipping</span>
                  <span className="text-green-400 font-bold uppercase text-xs tracking-wider bg-green-400/10 px-2 py-0.5 rounded">
                    Free
                  </span>
                </div>
                <div className="flex justify-between">
              ...
              {/* Link component ka use karein taaki click karne par checkout page par ja sakein */}
              <Link
                href="/checkout"
                className="w-full bg-white text-black hover:bg-gray-200 font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.15)]"
              >
